...
require (
	github.com/kucjac/cleango v0.0.19
	github.com/kucjac/cleango/database/es/esxsql v0.0.19
	github.com/kucjac/cleango/database/xpq v0.0.19
	github.com/kucjac/cleango/database/xsql v0.0.19
