...
// Source: github.com/kucjac/cleango/eventsource (interfaces: Storage)
...
func (m *MockStorage) GetSnapshot(arg0 context.Context, arg1, arg2 string, arg3 int64) (*eventsource.Snapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSnapshot", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*eventsource.Snapshot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStorage) NewCursor(arg0 context.Context, arg1 string, arg2 int64) (eventsource.Cursor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewCursor", arg0, arg1, arg2)
	ret0, _ := ret[0].(eventsource.Cursor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStorage) SaveEvents(arg0 context.Context, arg1 []*eventsource.Event) error {
	m.ctrl.T.Helper()
...
func (m *MockStorage) SaveSnapshot(arg0 context.Context, arg1 *eventsource.Snapshot) error {
	m.ctrl.T.Helper()
